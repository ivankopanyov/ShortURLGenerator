...
public interface IConnectionRepository
{
    ...
    /// </returns>
    Task<Grpc.Services.Connection?> GetOrDefaultAsync(string id);
    ...
    Task<ConnectionsPage> GetByUserIdAsync(long userId, int index, int size);
    ...
    Task<Grpc.Services.Connection> CreateAsync(Grpc.Services.Connection item);
